...
export class Board extends GUIVR.GuiVR {
	...
	loader.load('../extern/fonts/helvetiker_bold.typeface.json', function (font){
	    var textGeo = new THREE.TextBufferGeometry("Wu's Algorithm", {
		font: font,
		size: 0.15,
		height: 0.02,
		curveSegments: 3,
	    });
	    var textMaterial = new THREE.MeshNormalMaterial({color: 0xFFFFFF, specular: 0x000000});
	    var debug_mesh = new THREE.Mesh(textGeo, textMaterial);
	    debug_mesh.position.x = -0.75;
